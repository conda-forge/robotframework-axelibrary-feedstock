About robotframework-axelibrary
===============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/robotframework-axelibrary-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14934&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/robotframework-axelibrary-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `robotframework-axelibrary` can be installed with:

```
conda install robotframework-axelibrary
```

It is possible to list all of the versions of `robotframework-axelibrary` available on your platform with:
